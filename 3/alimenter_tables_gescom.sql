...
-- --------------------------------------------------------
--TABLE COUNTRIES IS ALREADY COMPLETE
-----------------------------------------------------------
...
INSERT INTO 'customer'
    ('cus_lastname', 'cus_first_name', 'cus_address', 'cus_zipcode', 'cus_city', 'cus_countries_id', 'cus_mail', 'cus_phone', 'cus_password', 'cus_add_date', 'cus_update_date')
VALUES
    ('Cavel', 'Catherine', '35 Naunton Lane', '60190', 'Estrées St Denis', 'FR', 'ccavel@email.fr',0654321111, 'sdqfqgfqgsdf', '2020-03-02 21:11:28', '2017-01-02 23:57:08'),
    ('Houseman', 'Peter', '12 rue Uranus', '60200', 'Compiègne', 'FR', 'phouseman@email.fr', 0654321112, 'shdjgdjsgh', '2020-03-02 21:11:28', '2017-01-02 23:57:08'),
    ('Samuel', 'Sam', '8 Trampo Street', '60193', 'Epineuse', 'FR', 'ssamuel@email.fr',0654321112, 'hkjhgjdgfhfg', '2020-03-02 21:11:28', '2017-01-02 23:57:08');
...
VALUES
    (2, 3, 'Brown', 'Billy', '1 Shipment Lane', 'gl537bj', 'Cheltenham', 'bbrown@email.com', 0124225678, 2000, '2020-25-11', 'M', 2),
    (NULL, 8, 'Williams', 'Willy', '2 Shipement Lane', 'gl537bj', 'Cheltenham', 'wwilliams@email.com', 0124225896, 4000, '2020-25-11', 'M', 1),
    (2, 4, 'Emerton', 'Emily', '3 Shipement Lane', 'gl537bj', 'Cheltenham', 'eemerton@email.com', 0124365896, 2200, '2020-25-11', 'F', 3),
---------------------------------------------------------------------------------------------------------------
...
VALUES
    ('2020-25-11', '2020-23-12', '2020-24-12', '2020-25-12', 'urgente', 1),
    ('2020-25-11', '2020-10-11', '2020-21-12', '2020-25-12', 'urgente', 2),
    ('2021-01-03', '2021-01-12', '2021-08-12', '2021-09-12', 'urgente', 3);
--
...
-- --------------------------------------------------------
--TABLE ORDER_DETAILS IS ALREADY COMPLETE
-----------------------------------------------------------
...
-- --------------------------------------------------------
--PRODUCTS TABLE IS ALREADY COMPLETE
------------------------------------------------------------
...
VALUES
    ('Potters', 'Bristol', 'UK', '2 Baldwin Street', 'BS11L', 'George Geogio', '012585369', 'gg@email.com'),
    ('Polecat Ltd', 'Bristol', 'UK', 'Newminster House', 'BS11L', 'Joanne Joans', '01254639', 'jjoans@email.com'),
    ('Zubanubi Ltd', 'Bristol', 'UK', '27 Baldwin Street', 'BS11L', 'David Davis', '0125563987', 'ddavis@email.com');
